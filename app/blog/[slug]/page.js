...
export default function Page({ params }) {
  ...
  return (
    <>
      <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white  antialiased dark:text-black">
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
          <article class=" w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <header class="mb-4 lg:mb-6 not-format">
              ...
              <h1 class="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-black">
      ...
      <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8 w-[50%]" />

      <aside aria-label="Related articles" class="py-8 lg:py-24">
        <div class="px-4 mx-auto max-w-screen-xl">
          <h2 class="mb-8 text-2xl font-bold text-center xl:text-5xl  dark:text-black">
            You May Also Like
          </h2>
          <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            <article class="max-w-xs">
              ...
              <h2 class="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-black">
      ...
      <section class="pb-[5%]">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 bg-white dark:bg-gray-900 rounded-[60px]">
